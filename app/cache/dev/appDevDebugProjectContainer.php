...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'nami_core.authentication_failure_listener' => 'getNamiCore_AuthenticationFailureListenerService',
            'nami_core.authentication_success_listener' => 'getNamiCore_AuthenticationSuccessListenerService',
            'nami_core.image_preserialize_subscriber' => 'getNamiCore_ImagePreserializeSubscriberService',
            'nami_core.json_decoder' => 'getNamiCore_JsonDecoderService',
            'nami_core.jwt_decoded_listener' => 'getNamiCore_JwtDecodedListenerService',
            'nami_core.listener' => 'getNamiCore_ListenerService',
            'nami_core.mailer' => 'getNamiCore_MailerService',
            'nami_core.plugin_registry' => 'getNamiCore_PluginRegistryService',
            'nami_core.plugin_routing_loader' => 'getNamiCore_PluginRoutingLoaderService',
            'nami_core.references_preserialize_subscriber' => 'getNamiCore_ReferencesPreserializeSubscriberService',
            'nami_core.twig_extensions' => 'getNamiCore_TwigExtensionsService',
            'nami_core.user_provider' => 'getNamiCore_UserProviderService',
            'nami_core.util.token_generator' => 'getNamiCore_Util_TokenGeneratorService',
            'namiplugin_sitemap_controller' => 'getNamipluginSitemapControllerService',
            ...
            'security.firewall.map.context.index' => 'getSecurity_Firewall_Map_Context_IndexService',
            'security.firewall.map.context.page_getter' => 'getSecurity_Firewall_Map_Context_PageGetterService',
            'security.firewall.map.context.reset_confirm' => 'getSecurity_Firewall_Map_Context_ResetConfirmService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'NamiCoreBundle', ($this->targetDirs[2].'/Resources/NamiCoreBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'NamiCoreBundle', ($this->targetDirs[4].'/phpink/nami-core-bundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'NamiAdminBundle', ($this->targetDirs[2].'/Resources/NamiAdminBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'NamiAdminBundle', ($this->targetDirs[3].'/vendor/phpink/nami-admin-bundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeThemeBundle', ($this->targetDirs[2].'/Resources/AcmeThemeBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeThemeBundle', ($this->targetDirs[3].'/src/Acme/ThemeBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.controller', array(0 => 'nami_core.listener', 1 => 'onKernelController'), 0);
        $instance->addListenerService('lexik_jwt_authentication.on_authentication_success', array(0 => 'nami_core.authentication_success_listener', 1 => 'onAuthenticationSuccessResponse'), 0);
        $instance->addListenerService('lexik_jwt_authentication.on_authentication_failure', array(0 => 'nami_core.authentication_failure_listener', 1 => 'onAuthenticationFailureResponse'), 0);
        $instance->addListenerService('lexik_jwt_authentication.on_jwt_decoded', array(0 => 'nami_core.jwt_decoded_listener', 1 => 'onJWTDecodedResponse'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'nami2', 'user' => 'root', 'password' => 'mysql', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $c, $f, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/vendor/gedmo/doctrine-extensions/lib/Gedmo/Tree/Document'), 1 => ($this->targetDirs[4].'/phpink/nami-core-bundle/Model/Orm')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Gedmo\\Tree\\Document');
        $c->addDriver($b, 'PhpInk\\Nami\\CoreBundle\\Model\\Orm');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('GedmoTree' => 'Gedmo\\Tree\\Document', 'NamiCoreBundle' => 'PhpInk\\Nami\\CoreBundle\\Model\\Orm'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f873003f0924b862edb87fed503cd7f01c91dcf70401f0ea06a3921054f072d2');
    ...
    {
        return $this->services['fos_js_routing.extractor'] = new \FOS\JsRoutingBundle\Extractor\ExposedRoutesExtractor($this->get('router'), array(), __DIR__, array('FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle', 'SecurityBundle' => 'Symfony\\Bundle\\SecurityBundle\\SecurityBundle', 'TwigBundle' => 'Symfony\\Bundle\\TwigBundle\\TwigBundle', 'MonologBundle' => 'Symfony\\Bundle\\MonologBundle\\MonologBundle', 'AsseticBundle' => 'Symfony\\Bundle\\AsseticBundle\\AsseticBundle', 'FOSHttpCacheBundle' => 'FOS\\HttpCacheBundle\\FOSHttpCacheBundle', 'SwiftmailerBundle' => 'Symfony\\Bundle\\SwiftmailerBundle\\SwiftmailerBundle', 'DoctrineBundle' => 'Doctrine\\Bundle\\DoctrineBundle\\DoctrineBundle', 'StofDoctrineExtensionsBundle' => 'Stof\\DoctrineExtensionsBundle\\StofDoctrineExtensionsBundle', 'SensioFrameworkExtraBundle' => 'Sensio\\Bundle\\FrameworkExtraBundle\\SensioFrameworkExtraBundle', 'JMSSerializerBundle' => 'JMS\\SerializerBundle\\JMSSerializerBundle', 'FOSRestBundle' => 'FOS\\RestBundle\\FOSRestBundle', 'BazingaHateoasBundle' => 'Bazinga\\Bundle\\HateoasBundle\\BazingaHateoasBundle', 'LiipImagineBundle' => 'Liip\\ImagineBundle\\LiipImagineBundle', 'NelmioApiDocBundle' => 'Nelmio\\ApiDocBundle\\NelmioApiDocBundle', 'LexikJWTAuthenticationBundle' => 'Lexik\\Bundle\\JWTAuthenticationBundle\\LexikJWTAuthenticationBundle', 'GfreeauGetJWTBundle' => 'Gfreeau\\Bundle\\GetJWTBundle\\GfreeauGetJWTBundle', 'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle', 'NamiCoreBundle' => 'PhpInk\\Nami\\CoreBundle\\NamiCoreBundle', 'NamiAdminBundle' => 'PhpInk\\Nami\\AdminBundle\\NamiAdminBundle', 'AcmeThemeBundle' => 'Acme\\ThemeBundle\\AcmeThemeBundle', 'WebProfilerBundle' => 'Symfony\\Bundle\\WebProfilerBundle\\WebProfilerBundle', 'SensioDistributionBundle' => 'Sensio\\Bundle\\DistributionBundle\\SensioDistributionBundle', 'SensioGeneratorBundle' => 'Sensio\\Bundle\\GeneratorBundle\\SensioGeneratorBundle', 'DoctrineFixturesBundle' => 'Doctrine\\Bundle\\FixturesBundle\\DoctrineFixturesBundle'));
    }
    ...
    {
        $this->services['fos_rest.decoder_provider'] = $instance = new \FOS\RestBundle\Decoder\ContainerDecoderProvider(array('json' => 'nami_core.json_decoder'));
    ...
    protected function getFosRest_ExceptionFormatNegotiatorService()
    {
        ...
        $instance->add($this->get('fos_rest.request_matcher.8615024800e4193600fd69885f7587200427156c3f94286d4b2ddc9c87897c17c762ebe2'), array('priorities' => array(0 => 'json'), 'fallback_format' => 'json', 'prefer_extension' => false, 'methods' => NULL, 'stop' => false));
        $instance->add($this->get('fos_rest.request_matcher.0dfc4cce134bee15f08405cb5cea4845b13ff7d8c8f779004218432a2c552bd0cd9f9d27'), array('priorities' => array(0 => 'html', 1 => 'application/javascript', 2 => 'text/css', 3 => '*/*'), 'methods' => NULL, 'stop' => false, 'prefer_extension' => '2.0', 'fallback_format' => 'html'));
    ...
    protected function getJmsSerializerService()
    {
        ...
        $a->setListeners(array('serializer.pre_serialize' => array(0 => array(0 => array(0 => 'jms_serializer.stopwatch_subscriber', 1 => 'onPreSerialize'), 1 => NULL, 2 => NULL), 1 => array(0 => array(0 => 'jms_serializer.doctrine_proxy_subscriber', 1 => 'onPreSerialize'), 1 => NULL, 2 => NULL), 2 => array(0 => array(0 => 'nami_core.references_preserialize_subscriber', 1 => 'onPreSerialize'), 1 => NULL, 2 => NULL), 3 => array(0 => array(0 => 'nami_core.image_preserialize_subscriber', 1 => 'onPreSerialize'), 1 => NULL, 2 => NULL)), 'serializer.post_serialize' => array(0 => array(0 => array(0 => 'hateoas.event_subscriber.xml', 1 => 'onPostSerialize'), 1 => NULL, 2 => 'xml'), 1 => array(0 => array(0 => 'hateoas.event_subscriber.json', 1 => 'onPostSerialize'), 1 => NULL, 2 => 'json'), 2 => array(0 => array(0 => 'jms_serializer.stopwatch_subscriber', 1 => 'onPostSerialize'), 1 => NULL, 2 => NULL))));
    ...
    {
        return $this->services['lexik_jwt_authentication.jwt_encoder'] = new \Lexik\Bundle\JWTAuthenticationBundle\Encoder\JWTEncoder(($this->targetDirs[2].'/../vendor/phpink/nami-core-bundle/Resources/config/jwt/public.pem'), ($this->targetDirs[2].'/../vendor/phpink/nami-core-bundle/Resources/config/jwt/private.pem'), '');
    }
    ...
    {
        return $this->services['liip_imagine.cache.signer'] = new \Liip\ImagineBundle\Imagine\Cache\Signer('l9Y3prfZW2aE34olJVzvdXuUr5k6yyASmB3ShdMhH8k');
    }
    ...
    {
        return $this->services['liip_imagine.filter.configuration'] = new \Liip\ImagineBundle\Imagine\Filter\FilterConfiguration(array('cache' => array('quality' => 100, 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'filters' => array(), 'post_processors' => array()), 'preview' => array('quality' => 75, 'filters' => array('thumbnail' => array('size' => array(0 => 125, 1 => 125), 'mode' => 'outbound', 'allow_upscale' => true), 'category' => array('size' => array(0 => 360, 1 => 329), 'mode' => 'outbound', 'allow_upscale' => true)), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array())));
    }
    ...
    /**
     * Gets the 'nami_core.authentication_failure_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PhpInk\Nami\CoreBundle\EventListener\AuthenticationFailureListener A PhpInk\Nami\CoreBundle\EventListener\AuthenticationFailureListener instance.
     */
    protected function getNamiCore_AuthenticationFailureListenerService()
    {
        return $this->services['nami_core.authentication_failure_listener'] = new \PhpInk\Nami\CoreBundle\EventListener\AuthenticationFailureListener();
    }

    /**
     * Gets the 'nami_core.authentication_success_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PhpInk\Nami\CoreBundle\EventListener\AuthenticationSuccessListener A PhpInk\Nami\CoreBundle\EventListener\AuthenticationSuccessListener instance.
     */
    protected function getNamiCore_AuthenticationSuccessListenerService()
    {
        return $this->services['nami_core.authentication_success_listener'] = new \PhpInk\Nami\CoreBundle\EventListener\AuthenticationSuccessListener($this->get('jms_serializer'));
    }

    /**
     * Gets the 'nami_core.image_preserialize_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PhpInk\Nami\CoreBundle\EventListener\ImagePreSerializeSubscriber A PhpInk\Nami\CoreBundle\EventListener\ImagePreSerializeSubscriber instance.
     */
    protected function getNamiCore_ImagePreserializeSubscriberService()
    {
        return $this->services['nami_core.image_preserialize_subscriber'] = new \PhpInk\Nami\CoreBundle\EventListener\ImagePreSerializeSubscriber($this->get('liip_imagine.cache.manager'), '/media/upload');
    }

    /**
     * Gets the 'nami_core.json_decoder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PhpInk\Nami\CoreBundle\Decoder\JsonDecoder A PhpInk\Nami\CoreBundle\Decoder\JsonDecoder instance.
     */
    protected function getNamiCore_JsonDecoderService()
    {
        return $this->services['nami_core.json_decoder'] = new \PhpInk\Nami\CoreBundle\Decoder\JsonDecoder();
    }

    /**
     * Gets the 'nami_core.jwt_decoded_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PhpInk\Nami\CoreBundle\EventListener\JWTDecodedListener A PhpInk\Nami\CoreBundle\EventListener\JWTDecodedListener instance.
     */
    protected function getNamiCore_JwtDecodedListenerService()
    {
        return $this->services['nami_core.jwt_decoded_listener'] = new \PhpInk\Nami\CoreBundle\EventListener\JWTDecodedListener();
    }

    /**
     * Gets the 'nami_core.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PhpInk\Nami\CoreBundle\EventListener\ControllerListener A PhpInk\Nami\CoreBundle\EventListener\ControllerListener instance.
     */
    protected function getNamiCore_ListenerService()
    {
        return $this->services['nami_core.listener'] = new \PhpInk\Nami\CoreBundle\EventListener\ControllerListener('http://www.nami.dev', $this->targetDirs[2], 'dev', '/media/upload', ($this->targetDirs[2].'/../plugins'), $this->get('nami_core.twig_extensions'));
    }

    /**
     * Gets the 'nami_core.mailer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PhpInk\Nami\CoreBundle\Mailer\TwigSwiftMailer A PhpInk\Nami\CoreBundle\Mailer\TwigSwiftMailer instance.
     */
    protected function getNamiCore_MailerService()
    {
        return $this->services['nami_core.mailer'] = new \PhpInk\Nami\CoreBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('twig'), array('url' => array('confirmation' => 'http://www.nami.dev/user/confirm/{token}', 'resetting' => 'http://www.nami.dev/user/reset/{token}'), 'template' => array('confirmation' => 'NamiCoreBundle:Emails:registration.txt.twig', 'resetting' => 'NamiCoreBundle:Emails:resetting.txt.twig'), 'from_email' => array('confirmation' => 'contact@localhost', 'resetting' => 'contact@localhost')));
    }

    /**
     * Gets the 'nami_core.plugin_registry' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PhpInk\Nami\CoreBundle\Plugin\Registry A PhpInk\Nami\CoreBundle\Plugin\Registry instance.
     */
    protected function getNamiCore_PluginRegistryService()
    {
        return $this->services['nami_core.plugin_registry'] = new \PhpInk\Nami\CoreBundle\Plugin\Registry(($this->targetDirs[2].'/../plugins'));
    }

    /**
     * Gets the 'nami_core.plugin_routing_loader' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PhpInk\Nami\CoreBundle\Plugin\RoutingLoader A PhpInk\Nami\CoreBundle\Plugin\RoutingLoader instance.
     */
    protected function getNamiCore_PluginRoutingLoaderService()
    {
        return $this->services['nami_core.plugin_routing_loader'] = new \PhpInk\Nami\CoreBundle\Plugin\RoutingLoader(($this->targetDirs[2].'/../plugins'));
    }

    /**
     * Gets the 'nami_core.references_preserialize_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PhpInk\Nami\CoreBundle\EventListener\RefPreSerializeSubscriber A PhpInk\Nami\CoreBundle\EventListener\RefPreSerializeSubscriber instance.
     */
    protected function getNamiCore_ReferencesPreserializeSubscriberService()
    {
        return $this->services['nami_core.references_preserialize_subscriber'] = new \PhpInk\Nami\CoreBundle\EventListener\RefPreSerializeSubscriber($this->get('security.token_storage'));
    }

    /**
     * Gets the 'nami_core.twig_extensions' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PhpInk\Nami\CoreBundle\Twig\TwigExtension A PhpInk\Nami\CoreBundle\Twig\TwigExtension instance.
     */
    protected function getNamiCore_TwigExtensionsService()
    {
        return $this->services['nami_core.twig_extensions'] = new \PhpInk\Nami\CoreBundle\Twig\TwigExtension($this->get('twig.loader'));
    }

    /**
     * Gets the 'nami_core.user_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PhpInk\Nami\CoreBundle\Security\UserProvider A PhpInk\Nami\CoreBundle\Security\UserProvider instance.
     */
    protected function getNamiCore_UserProviderService()
    {
        $this->services['nami_core.user_provider'] = $instance = new \PhpInk\Nami\CoreBundle\Security\UserProvider($this->get('security.password_encoder'));
    ...
    /**
     * Gets the 'nami_core.util.token_generator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PhpInk\Nami\CoreBundle\Util\TokenGenerator A PhpInk\Nami\CoreBundle\Util\TokenGenerator instance.
     */
    protected function getNamiCore_Util_TokenGeneratorService()
    {
        return $this->services['nami_core.util.token_generator'] = new \PhpInk\Nami\CoreBundle\Util\TokenGenerator($this->get('logger'));
    }

    /**
     * Gets the 'namiplugin_sitemap_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \NamiPlugin\Sitemap\Controller\SitemapController A NamiPlugin\Sitemap\Controller\SitemapController instance.
     */
    protected function getNamipluginSitemapControllerService()
    {
        return $this->services['namiplugin_sitemap_controller'] = new \NamiPlugin\Sitemap\Controller\SitemapController($this);
    }
    ...
    protected function getRouting_LoaderService()
    {
        ...
        $d->addLoader($this->get('nami_core.plugin_routing_loader'));
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('PhpInk\\Nami\\CoreBundle\\Model\\Odm\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000)), 'PhpInk\\Nami\\CoreBundle\\Model\\Orm\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.index' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/$'), 'security.firewall.map.context.page_getter' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/pages/url'), 'security.firewall.map.context.reset_confirm' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/users/(reset|confirm|register)$'), 'security.firewall.map.context.token' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/users/token$'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_ApiService()
    {
        ...
        $b = new \Lexik\Bundle\JWTAuthenticationBundle\Security\Firewall\JWTListener($a, $this->get('security.authentication.manager'), array('authorization_header' => array('enabled' => true, 'prefix' => 'Bearer', 'name' => 'Authorization'), 'cookie' => array('enabled' => false, 'name' => 'BEARER'), 'query_parameter' => array('enabled' => true, 'name' => 'bearer'), 'throw_exceptions' => false, 'create_entry_point' => true, 'authentication_provider' => 'lexik_jwt_authentication.security.authentication.provider', 'authentication_listener' => 'lexik_jwt_authentication.security.authentication.listener'));
        ...
        $b->addTokenExtractor(new \Lexik\Bundle\JWTAuthenticationBundle\TokenExtractor\QueryParameterTokenExtractor('bearer'));
    ...
    /**
     * Gets the 'security.firewall.map.context.index' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_IndexService()
    {
        return $this->services['security.firewall.map.context.index'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }

    /**
     * Gets the 'security.firewall.map.context.page_getter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_PageGetterService()
    {
        return $this->services['security.firewall.map.context.page_getter'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }

    /**
     * Gets the 'security.firewall.map.context.reset_confirm' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_ResetConfirmService()
    {
        return $this->services['security.firewall.map.context.reset_confirm'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_TokenService()
    {
        ...
        return $this->services['security.firewall.map.context.token'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Gfreeau\Bundle\GetJWTBundle\Security\Firewall\GetJWTListener($a, $this->get('security.authentication.manager'), 'token', $this->get('lexik_jwt_authentication.handler.authentication_success'), $this->get('lexik_jwt_authentication.handler.authentication_failure'), array('username_parameter' => 'username', 'password_parameter' => 'password', 'post_only' => true, 'success_handler' => 'lexik_jwt_authentication.handler.authentication_success', 'failure_handler' => 'lexik_jwt_authentication.handler.authentication_failure', 'throw_exceptions' => false, 'authentication_provider' => 'security.authentication.provider.dao', 'user_checker' => 'security.user_checker'), $b), 2 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'token', NULL, NULL, NULL, $b, true));
    }
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin(array(0 => 'dev@localhost'), array());
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'NamiCoreBundle', 1 => 'NamiAdminBundle', 2 => 'AcmeThemeBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        ...
        $instance->addExtension($this->get('nami_core.twig_extensions'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[2].'/../plugins/NamiPlugin'), 'NamiPlugin');
        ...
        $instance->addPath(($this->targetDirs[4].'/phpink/nami-core-bundle/Resources/views'), 'NamiCore');
        $instance->addPath(($this->targetDirs[3].'/vendor/phpink/nami-admin-bundle/Resources/views'), 'NamiAdmin');
        $instance->addPath(($this->targetDirs[3].'/src/Acme/ThemeBundle/Resources/views'), 'AcmeTheme');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('l9Y3prfZW2aE34olJVzvdXuUr5k6yyASmB3ShdMhH8k');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[4].'/phpink/nami-core-bundle/Resources/config/validation.yml')));
    ...
    {
        return $this->services['jms_serializer.metadata.file_locator'] = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'/vendor/symfony/assetic-bundle/Resources/config/serializer'), 'FOS\\HttpCacheBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/http-cache-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Stof\\DoctrineExtensionsBundle' => ($this->targetDirs[3].'/vendor/stof/doctrine-extensions-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer'), 'Bazinga\\Bundle\\HateoasBundle' => ($this->targetDirs[3].'/vendor/willdurand/hateoas-bundle/Bazinga/Bundle/HateoasBundle/Resources/config/serializer'), 'Liip\\ImagineBundle' => ($this->targetDirs[3].'/vendor/liip/imagine-bundle/Resources/config/serializer'), 'Nelmio\\ApiDocBundle' => ($this->targetDirs[3].'/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/config/serializer'), 'Lexik\\Bundle\\JWTAuthenticationBundle' => ($this->targetDirs[3].'/vendor/lexik/jwt-authentication-bundle/Lexik/Bundle/JWTAuthenticationBundle/Resources/config/serializer'), 'Gfreeau\\Bundle\\GetJWTBundle' => ($this->targetDirs[3].'/vendor/gfreeau/get-jwt-bundle/Gfreeau/Bundle/GetJWTBundle/Resources/config/serializer'), 'FOS\\JsRoutingBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/jsrouting-bundle/Resources/config/serializer'), 'PhpInk\\Nami\\CoreBundle' => ($this->targetDirs[4].'/phpink/nami-core-bundle/Resources/config/serializer'), 'PhpInk\\Nami\\AdminBundle' => ($this->targetDirs[3].'/vendor/phpink/nami-admin-bundle/Resources/config/serializer'), 'Acme\\ThemeBundle' => ($this->targetDirs[3].'/src/Acme/ThemeBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\FixturesBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-fixtures-bundle/Resources/config/serializer')));
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api-doc/'), array(0 => 'ROLE_SUPER_ADMIN', 1 => 'ROLE_ADMIN'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $b = $this->get('nami_core.user_provider');

        $c = new \Lexik\Bundle\JWTAuthenticationBundle\Security\Authentication\Provider\JWTProvider($b, $this->get('lexik_jwt_authentication.jwt_manager'), $a);
        $c->setUserIdentityField('username');

        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($b, new \Symfony\Component\Security\Core\User\UserChecker(), 'token', $this->get('security.encoder_factory'), true), 1 => $c), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'NamiCoreBundle' => 'PhpInk\\Nami\\CoreBundle\\NamiCoreBundle',
                'NamiAdminBundle' => 'PhpInk\\Nami\\AdminBundle\\NamiAdminBundle',
                'AcmeThemeBundle' => 'Acme\\ThemeBundle\\AcmeThemeBundle',
            ...
            'host' => 'http://www.nami.dev',
            'secret' => 'l9Y3prfZW2aE34olJVzvdXuUr5k6yyASmB3ShdMhH8k',
            'nami_core.database_adapter' => 'orm',
            'nami_core.database_driver' => 'pdo_mysql',
            'nami_core.database_host' => 'localhost',
            'nami_core.database_name' => 'nami2',
            'nami_core.database_port' => 3306,
            'nami_core.database_user' => 'root',
            'nami_core.database_pass' => 'mysql',
            'nami_core.cache_host' => 'localhost',
            'nami_core.cache_port' => 27017,
            'nami_core.locale' => 'en',
            'nami_core.upload_dir' => '/media/upload',
            'nami_core.plugin_path' => ($this->targetDirs[2].'/../plugins'),
            'nami_core.mailer_to' => 'dev@localhost',
            'nami_core.mailer_from' => 'contact@localhost',
            'nami_core.mailer_transport' => NULL,
            'nami_core.mailer_host' => 'localhost',
            'nami_core.mailer_port' => 25,
            'nami_core.mailer_username' => NULL,
            'nami_core.mailer_password' => NULL,
            'nami_core.mailer_encryption' => NULL,
            'nami_core.private_key_path' => ($this->targetDirs[2].'/../vendor/phpink/nami-core-bundle/Resources/config/jwt/public.pem'),
            'nami_core.public_key_path' => ($this->targetDirs[2].'/../vendor/phpink/nami-core-bundle/Resources/config/jwt/private.pem'),
            'nami_core.ssh_passphrase' => '',
            'nami_core.token_ttl' => 86400,
            'nami_core.reset_token_ttl' => 604800,
            'nami_core.front_url' => 'http://www.nami.dev',
            'nami_core.front_url_confirmation' => 'http://www.nami.dev/user/confirm/{token}',
            'nami_core.front_url_resetting' => 'http://www.nami.dev/user/reset/{token}',
            'nami_core.google_api_keyfile' => NULL,
            'nami_core.google_api_id' => NULL,
            'nami_core.google_analytics_view' => NULL,
            ...
            'kernel.secret' => 'l9Y3prfZW2aE34olJVzvdXuUr5k6yyASmB3ShdMhH8k',
            ...
            'swiftmailer.mailer.default.single_address' => 'dev@localhost',
            ...
            'swiftmailer.single_address' => 'dev@localhost',
            ...
            'lexik_jwt_authentication.private_key_path' => ($this->targetDirs[2].'/../vendor/phpink/nami-core-bundle/Resources/config/jwt/public.pem'),
            'lexik_jwt_authentication.public_key_path' => ($this->targetDirs[2].'/../vendor/phpink/nami-core-bundle/Resources/config/jwt/private.pem'),
            ...
            'namiplugin.contactform.mail_to' => 'email@provider.com',
            'namiplugin.contactform.mail_template' => '@NamiPlugin/ContactForm/views/mail.html.twig',
            'namiplugin.contactform.block_template' => '@NamiPlugin/ContactForm/views/block.html.twig',
        );
    }
}
